...
public class Forward {
	public static void main(String[] args){
		...
		double sss=1234.5678;
		String string=String.format("%.2f", sss);
...
class thread1 implements Runnable{
	...
	public static void initializtion(){
		...
		if(input1.equals("begin")){
			...
			int x=(int) ((5-rank)*70+Math.random()*70);
			int v=(int) (25+Math.random()*10);
			...
			Global.configurefile[0][1]=Integer.toString(x);
			Global.configurefile[0][2]=Integer.toString(v);
