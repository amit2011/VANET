...
public class broadcast {
	...
	public void broadcastmsg(comdata xva) throws IOException{
		...
		InetAddress broadcastIPAddress = InetAddress.getByName("131.204.14.255");
	...
	void throughput(){
		...
		if(nowtime>(Global.inittime+1000)){
			Global.throughput=Global.throughputnum/1000;
			System.out.println(Global.throughput);
